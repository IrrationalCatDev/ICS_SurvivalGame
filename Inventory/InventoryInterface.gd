		...
		[null, MOUSE_BUTTON_LEFT]:
			...
			if Input.is_key_pressed(KEY_SHIFT):
				...
				if external_inventory_owner and external_inventory_owner.inventory_data == inventory_data:
					success = player_inventory.inventory_data.pick_up_slot_data(grabbed_slot_data)
				else:
					success = external_inventory_owner.inventory_data.pick_up_slot_data(grabbed_slot_data)
				if success:
